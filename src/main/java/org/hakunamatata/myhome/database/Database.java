...
public class Database {
	...
	public static void main(String args[]) {
		...
		Address house_address = new Address("9star hills residency", "hyderabad", "telangana", "india", 500089, 1,
				"Home");
		House h1 = new House(parentId, "testhome1", 1002, "Admin", new Date(), null, null, 0, null);
		h1.setHouseAddress(house_address);
		h1.setHouseType(1);

		Comment c1 = new Comment(h1.getDataId(), "Auto generated comment", 10, "Admin", new Date(), "Admin",
				new Date(), 0, null);
		c1.setComment("Hello my first comment");
		c1.getMembersMentioned().add(m1);

		Comment c2 = new Comment(h1.getDataId(), "Auto generated comment", 10, "Admin", new Date(), "Admin",
				new Date(), 0, null);
		c2.setComment("my second comment");
		c2.getMembersTagged().add(m1);

		Reaction r1 = new Reaction();
		r1.setReactedBy(m1);
		r1.setReactedNode(h1);
		r1.setReactedDate(new Date());
		r1.setReactionType(1);
